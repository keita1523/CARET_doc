...
- Timer Event Visualization
  ...
  If the difference between the time the timer event fires and the time the timer callback starts executing exceeds 5 ms, the callback execution is considered to be delayed. 